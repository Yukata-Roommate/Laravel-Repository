 ...
 *
 * @method \YukataRm\Laravel\Repository\Interfaces\ModelInterface|null first(int $id, array $columns = ["*"])
 * @method \Illuminate\Database\Eloquent\Collection<\YukataRm\Laravel\Repository\Interfaces\ModelInterface> get(array $columns = ["*"])
 *
 * @method \Illuminate\Contracts\Pagination\LengthAwarePaginator paginate(int|null $perPage = null, array $columns = ["*"], string $pageName = "page", int|null $page = null)
 * @method bool exists()
 ...
 * @method static join(string $table, string $first, string|null $operator = null, string|null $second = null, string $type = "inner", bool $where = false)
 * @method static leftJoin(string $table, string $first, string|null $operator = null, string|null $second = null)
 * @method static rightJoin(string $table, string $first, string|null $operator = null, string|null $second = null)
 * @method static crossJoin(string $table, string|null $first = null, string|null $operator = null, string|null $second = null)
 *
 ...
 * @method static having(string $column, string|null $operator = null, mixed $value = null, string $boolean = "and")
 * @method static orHaving(string $column, string|null $operator = null, mixed $value = null)
...
abstract class BaseRepository
{
     ...
     *
     * @param \Illuminate\Database\Eloquent\Collection<\YukataRm\Laravel\Repository\Interfaces\ModelInterface> | \Illuminate\Support\Collection<\YukataRm\Laravel\Repository\Interfaces\ModelInterface> $collection
     ...
     *
     * @param \Illuminate\Database\Eloquent\Collection<\YukataRm\Laravel\Repository\Interfaces\ModelInterface> $collection
